import { AGENT_RULES, renderThread } from './prompts.js';

export const MODES = {
  code: {
    diagnoseTools: ['Bash', 'Read', 'Grep'],
    executeTools: ['Bash', 'Read', 'Write', 'Edit'],
    diagnosePrompt: ({ apiBase, task, worktreePath, db }) => `DIAGNOSE task_id=${task.id}.
...
${AGENT_RULES} Output a one-line JSON summary.`,
